...
var site_ns = {
    ...
    hbars: {
        img: {
            ...
            '<img src="images/art/coffeepot.svg" style="float: left; width: 80px;"/>' +
            '</a>',
            ...
            '<img class="pics-left" src="images/art/menu-key.svg" style="width: 50px;"/>' +
            '</a>',
            ...
            '<img src="images/art/redbacteria.svg" style="width: 110px;"/>' +
            '</a></div>',
            manatwork: '<div class="pics-paper-clip" style="margin-top: 1px;margin-left: 80%;"> ' +
            '<a href="//openclipart.org/detail/147823/man-at-work">' +
            '<img src="images/art/manatwork.svg" style="width: 210px;"/>' +
            '</a></div>',
            onemistake: '<a href="//openclipart.org/detail/239007/the-ticket">' +
            '<img class="pics-left" src="images/art/onemistake.svg" style="width: 110px;"/>' +
            '</a>',
            windman: '<div><a href="https://openclipart.org/detail/233054/wind">' +
            '<img src="images/art/windman.svg" class="pics-right" style="width: 130px;"/>' +
            '</a></div>'
